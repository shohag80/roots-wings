...
<div class="container bg-body-secondary p-3 mt-2">
    <div class="row">
        ...
        <div class="text-end col-md-6 col-sm-8">
            ...
            <a href="{{route('add_category')}}" class="btn btn-outline-success">Add Category</a> |
            <a href="" class="btn btn-outline-info">Export</a>
        </div>
        <div class="col-md-3">
            <form class="form-inline" method="GET" action="{{ route('category_list') }}">
                <input name="search_category" class="form-control col-8 mr-sm-1" type="search" placeholder="Search" aria-label="Search">
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img height="50px" width="50px" src="{{url('/public/uploads/category_img/',$item->photo)}}" alt="photo">
                    </td>
                    <td>{{$item->name}}</td>
