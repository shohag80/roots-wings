...
<head>
    ...
    <!-- Libs CSS -->
    <link href="https://freshcart.codescandy.com/assets/libs/bootstrap-icons/font/bootstrap-icons.min.css"
        rel="stylesheet" />
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
                        <div class="mb-lg-9 mb-5">
                            ...
                            <p>Welcome to ROOTS & WINGS! Enter your email to get started.</p>
                        </div>
                        <!-- form -->
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="full_name" value="{{ old('full_name') }}"
                                        class="form-control" id="formSignupfname" placeholder="Full Name" required />
                                ...
                                <div class="col-12">
                                    <div class="form-outline">
                                        <label for="formSignupfnumber" class="form-label visually-hidden">Phone
                                            Number</label>
                                        <input type="number" name="phone" id="formSignupfnumber"
                                            value="{{ old('phone') }}" class="form-control"
                                            placeholder="Phone Number (+880)" required />
                                        @error('phone')
                                            {{ $message }}
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}"
                                        id="formSignupEmail" class="form-control" placeholder="Email" required />
                                    ...
                                    <div class="password-field position-relative">
                                        ...
                                        <div class="password-field position-relative">
                                            <input type="password" name="password" value="{{ old('password') }}"
                                                class="form-control fakePassword" id="formSignupPassword"
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 mt-4 mt-md-0">
                        <ul class="list-inline mb-0 text-lg-end text-center">
                            <li class="list-inline-item mb-2 mb-md-0 text-dark">Get deliveries with ROOTS & WINGS</li>
