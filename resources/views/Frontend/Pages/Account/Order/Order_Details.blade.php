                ...
                <div class="card border-top border-bottom border-4" style="border-color: green !important; background-color: #ffff;">
                    <div class="card-body">
                        <div class="container rounded-3 p-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="{{route('User_Pdf',$order->id)}}" class="btn btn-sm btn-outline-success"><i class="bi bi-download"></i></a>
                                </div>
                                <div class="col-md-6 d-flex justify-content-end">
                                    <a href="{{route('User_Print',$order->id)}}" class="btn btn-sm btn-outline-success" target="_blank"><i class="bi bi-printer"></i></a>
                                </div>
                            </div>
                            <h1 class="lead fw-bold text-center text-primary display-6"><u>Purchase Reciept</u></h1>
                        </div>
                            ...
                            <table class="table table-hover rounded">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td><img height="40" width="40" src="{{url('/public/uploads/',$item->product->photo)}}" alt=""></td>
