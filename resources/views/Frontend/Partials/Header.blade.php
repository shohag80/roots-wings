          ...
          <div class="dropdown selectBox">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="javascript:void(0)"><span class="me-2">
                <svg width="18" height="15" viewBox="0 0 160 96" xmlns="http://www.w3.org/2000/svg">
                  <!-- Green Background -->
                  <rect width="160" height="96" fill="green" />
                  <!-- Red Circle -->
                  <circle cx="70" cy="48" r="24" fill="red" />
                </svg>              
                </span>Bangla</a>
              </li>
            </ul>
        ...
        <div class="col-xxl-5 col-lg-5 d-none d-lg-block">
          <form action="{{route('Search')}}">
            <div class="input-group ">
              <input class="form-control rounded" name="search" type="search" placeholder="Search for products" value="@isset($input) {{$input}} @endisset">
        ...
        <div class="col-md-3 col-xxl-2 text-center d-none d-lg-block">
          <div class="list-inline">
            <div class="list-inline-item me-5">
              @auth
              <a href="{{route('Wish_List',auth()->user()->id)}}" class="text-muted position-relative">
              ...
              @endauth
              @guest
              <a href="{{route('SignIn')}}" class="text-muted position-relative">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                  <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z">
                  </path>
                </svg>
            ...
            <div class="list-inline-item me-5">
              <a class="text-muted position-relative" href="{{route('Cart')}}" role="button" aria-controls="offcanvasRight">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag">
                  <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
                  <line x1="3" y1="6" x2="21" y2="6"></line>
                  <path d="M16 10a4 4 0 0 1-8 0"></path>
    ...
    <div class="container">
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default" aria-labelledby="navbar-defaultLabel">
        <div class="offcanvas-header pb-1">
          <a href="#"><img src="" alt="ROOTS & WINGS"></a>
            ...
            <div class="collapse mt-2" id="collapseExample">
              <div class="card card-body">
                <ul class="mb-0 list-unstyled">
                  ...
                  <li><a class="dropdown-item" href="{{route('product_by_category',$item->id)}}">{{$item->name}}</a></li>
                  @endforeach
                </ul>
              </div>
            </div>
            ...
            <ul class="navbar-nav align-items-center ">
                ...
                <div class="dropdown-menu pb-0">
                  <div class="row p-2 p-lg-4">
                    <div class="col-md-9">
                      <div class="row">
                        @foreach($category as $item)
                          @foreach($sub_category->where('category_id', $item->id) as $single)
                            <div class="col-lg-3 col-12 mb-4 mb-lg-4">
                              <h6 class="text-primary ps-3">{{ $item->name }}</h6>
                                <a class="dropdown-item" href="#">{{ $single->name }}</a>
                            </div>
                          @endforeach
                        @endforeach
                      </div>
                    ...
                    <div class="col-md-3">
                      <div class="col-lg-12 col-12 mb-4 mb-lg-0">
                        <div class="card border-0">
                          <img src="{{url('asset\background\category-banner.jpg')}}" alt="Category Banner" class="img-fluid">
              ...
              <li class="nav-item dropdown w-100 w-lg-auto">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="{{route('All_Category')}}">Categories</a></li>
                  ...
                  <div class="password-field position-relative">
                      ...
                      <div class="password-field position-relative">
                          <input type="password" name="password" value="{{ old('password') }}"
                              class="form-control" id="formSigninPassword" placeholder="*****"
                              required />
      ...
      <div class="container">
        ...
        <div class="row mt-5 p-5">
          <div class="text-center rounded-5">
            <img height="150" width="150" style="border-radius: 50%;" src="{{url('/public/uploads/',auth()->guard()->user()->photo)}}" alt="">
            <div class="mt-2">
